...
5. **다음: PR #20 머지 → 외부 설정(Discord/HC/UptimeRobot/GH secret/.env) → 운영 검증** → carrer 쪽 포폴 알림·관측 카드 부활 + 대본 Q6·Q7 갱신. 이후 로드맵 4번 migration playbook → 다중 인스턴스 실증.
